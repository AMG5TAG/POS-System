...
import {
  ...
  MapPin, Repeat, Puzzle, Recycle, Image as ImageIcon, KeyRound, FolderOpen,
} from "lucide-react";
import {
...
const SEARCH_INDEX = [
  ...
  { label: "Themes",             href: "/management/customisation/themes",                   icon: Palette,         group: "Management" },
  ...
  { label: "Forms & Files",     href: "/management/forms-files/forms",                       icon: FileText,        group: "Management" },
  { label: "Files",             href: "/management/forms-files/files",                       icon: FolderOpen,      group: "Management" },
  { label: "Cloud Storage",     href: "/management/forms-files/cloud",                       icon: HardDrive,       group: "Management" },
  ...
  { label: "Uploads",           href: "/management/forms-files/uploads",                    icon: ImageIcon,       group: "Management" },
  { label: "Media Library",     href: "/management/forms-files/uploads",                    icon: ImageIcon,       group: "Management" },
  ...
  { label: "Labels",             href: "/management/customisation/templates/labels",       icon: Tag,             group: "Management" },
  { label: "Label Templates",    href: "/management/customisation/templates/labels",       icon: LayoutTemplate,  group: "Management" },
  ...
  { label: "Online Store",              href: "/management/online-store/storefront",  icon: Globe,        group: "Management" },
  ...
  { label: "Customer PDF Template", href: "/management/customisation/templates/misc",  icon: FileText,      group: "Management" },
  { label: "Email Templates",     href: "/management/customisation/templates/emails", icon: Mail,          group: "Management" },
...
const SEGMENT_LABEL: Record<string, string> = {
  ...
  "settings-integrations": "Settings",   // the hub renamed; the path segment did not
