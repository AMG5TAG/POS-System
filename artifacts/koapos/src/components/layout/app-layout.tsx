...
const SEARCH_INDEX = [
  ...
  { label: "Uploads",           href: "/management/customisation/uploads",                  icon: ImageIcon,       group: "Management" },
  { label: "Media Library",     href: "/management/customisation/uploads",                  icon: ImageIcon,       group: "Management" },
