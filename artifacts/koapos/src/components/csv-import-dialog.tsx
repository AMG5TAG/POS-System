...
const ENTITY_CONFIG: Record<"customer" | "product", EntityConfig> = {
  customer: {
    ...
    columns: [
      ...
      { key: "agreedToMarketing",  label: "Marketing"    },
    ],
    templateFilename: "customers-template.csv",
    templateContent: [
      "first_name,last_name,email,phone,address,loyalty_points,group,notes,agreed_to_marketing",
      "Jane,Smith,jane@example.com,0412345678,123 Main St Sydney,0,Standard,,false",
      "John,Doe,john@example.com,0498765432,,100,VIP,Prefers email contact,true",
    ].join("\n"),
