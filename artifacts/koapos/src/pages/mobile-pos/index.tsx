...
import {
  ...
  Search, X, Check, Banknote, CreditCard,
} from "lucide-react";
...
function InvoicesTab() {
  ...
  if (rows == null) return <div className="py-12 flex justify-center"><Loader2 className="w-6 h-6 animate-spin text-muted-foreground" /></div>;
  if (rows.length === 0) return <p className="py-12 text-center text-sm text-muted-foreground">No invoices yet.</p>;
