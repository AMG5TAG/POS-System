...
const ENTITIES: EntityConfig[] = [
  {
    ...
    sampleRows: [
      { firstName: "Sarah",  lastName: "Johnson", email: "sarah@example.com",  phone: "0412 345 678", address: "123 George St, Sydney NSW 2000",    company: "Johnson Group",   abn: "12 345 678 901", dateOfBirth: "1985-06-15", notes: "VIP customer" },
      { firstName: "Mike",   lastName: "Chen",    email: "mike@example.com",   phone: "0423 456 789", address: "456 Collins St, Melbourne VIC 3000", company: "",               abn: "",               dateOfBirth: "1990-03-20", notes: "" },
      { firstName: "Priya",  lastName: "Patel",   email: "priya@example.com",  phone: "0434 567 890", address: "789 Bourke St, Brisbane QLD 4000",   company: "Patel Pty Ltd",  abn: "98 765 432 109", dateOfBirth: "1978-11-08", notes: "Wholesale account" },
    ],
    toExportRow: (item) => ({
...
const ALIASES: Record<string, string[]> = {
  ...
  address:            ["address", "streetaddress", "street", "location", "addr"],
