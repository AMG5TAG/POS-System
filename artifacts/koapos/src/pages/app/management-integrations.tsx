...
function AppleSvg({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 814 1000" className={className} fill="currentColor" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <path d="M788.1 340.9c-5.8 4.5-108.2 62.2-108.2 190.5 0 148.4 130.3 200.9 134.2 202.2-.6 3.2-20.7 71.9-68.7 141.9-42.8 61.6-87.5 123.1-155.5 123.1s-85.5-39.5-164-39.5c-76 0-103.7 40.8-165.9 40.8s-105-42.4-150.3-109.7C34.3 752.5-5.7 632.7-5.7 519.4c0-226.7 148.4-346.3 293.3-346.3 73.4 0 134.9 48.4 181.1 48.4 44.3 0 114.4-51.3 197.9-51.3 32.1 0 131.5 2.6 198.2 103.4zm-234-181.5c31.1-36.9 53.1-88.1 53.1-139.3 0-7.1-.6-14.3-1.9-20.1-50.6 1.9-110.8 33.7-147.1 75.8-28.5 32.4-55.1 83.6-55.1 135.5 0 7.8 1.3 15.6 1.9 18.1 3.2.6 8.4 1.3 13.6 1.3 45.4 0 102.5-30.4 135.5-71.3z" />
    </svg>
  );
}
...
type LogoCfg =
  ...
  | { type: "svg";  bg: string; color: string; component: React.ComponentType<{ className?: string }> };
...
function IntegrationLogo({ integrationKey, size = "md" }: { integrationKey: string; size?: "sm" | "md" | "lg" }) {
  ...
  if (cfg.type === "svg") {
    const SvgComp = cfg.component;
    return (
      <div className={cn(dim, "rounded-2xl flex items-center justify-center shrink-0", cfg.bg)}>
        <SvgComp className={cn("object-contain", imgSize, cfg.color)} />
      </div>
    );
  }
  return (
...
const ALL_SECTIONS = [
  {
    ...
    icon: Landmark,
    description: "Sync sales, invoices, tax data, and purchase orders with your accounting software",
  ...
  },
  {
    ...
    icon: ShoppingBag,
    description: "Sync inventory, orders, and shipping across online storefronts and marketplaces",
    accent: "bg-amber-50/60 border-amber-200 dark:bg-amber-950/20 dark:border-amber-900",
  ...
  },
  {
    ...
    icon: CreditCard,
    description: "Card terminals, EFTPOS, buy-now-pay-later, and digital wallet providers",
    accent: "bg-emerald-50/60 border-emerald-200 dark:bg-emerald-950/20 dark:border-emerald-900",
  ...
  },
  {
    ...
    icon: Cloud,
    description: "Back up reports, sync contacts and calendars, and automate workflows",
