...
export const GetCustomerHistoryResponse = zod.object({
  ...
  "customerPhone": zod.string().nullish(),
  "customerEmail": zod.string().nullish(),
  "status": zod.enum(['pending', 'in-progress', 'awaiting-stock', 'awaiting-customer', 'completed', 'cancelled']),
...
export const CreateServiceJobBody = zod.object({
  "customerId": zod.number().nullish(),
  "staffId": zod.number().nullish(),
  "status": zod.enum(['pending', 'in-progress', 'awaiting-stock', 'awaiting-customer', 'completed', 'cancelled']).optional(),
