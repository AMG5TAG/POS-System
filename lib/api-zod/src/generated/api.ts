...
export const GetMeResponse = zod.object({
  ...
  "defaultPhoneCountry": zod.string().optional().describe('ISO 3166-1 alpha-2 country whose dialling code is appended to phone numbers saved without one, so \"0412 345 678\" is stored as \"+61412345678\". Empty means follow `country`.'),
...
export const UpdateMerchantBody = zod.object({
  ...
  "defaultPhoneCountry": zod.string().optional().describe('ISO 3166-1 alpha-2 country whose dialling code is appended to phone numbers saved without one. Empty means follow `country`.'),
  "currency": zod.string().optional(),
