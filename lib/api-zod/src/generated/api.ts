...
export const GetMeResponse = zod.object({
  ...
  "defaultPhoneCountry": zod.string().optional().describe('ISO 3166-1 alpha-2 country whose dialling code is appended to phone numbers saved without one, so \"0412 345 678\" is stored as \"+61412345678\". Empty means Australia.'),
  "phoneDisplay": zod.enum(['international', 'national']).optional().describe('How phone numbers are shown in the app. Display only — numbers are always stored with their country code.'),
...
export const UpdateMerchantBody = zod.object({
  ...
  "defaultPhoneCountry": zod.string().optional().describe('ISO 3166-1 alpha-2 country whose dialling code is appended to phone numbers saved without one. Empty means Australia.'),
  "phoneDisplay": zod.enum(['international', 'national']).optional().describe('How phone numbers are shown in the app. Display only.'),
  "currency": zod.string().optional(),
